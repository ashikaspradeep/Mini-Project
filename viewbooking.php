                        ...
                        <div class="col-lg-6 col-md-6">
                            ...
                            <h3>Booking Status</h3>
                                <table border="2">
                                    ...
                                    $sq=mysqli_query($connection,"select * from booking_det ");
                                    while($a=mysqli_fetch_array($sq))
                                    {
                                        ...
                                        <tr>
                                            ...
                                            if($a['status']=="Pending")
                                            {
                                                ?>
                                                <td>
                                                    <a href="bapr.php?id=<?php echo $a['id'];?>" style="color:green;">Approve</a> /
                                                    <a href="brej.php?id=<?php echo $a['id'];?>" style="color:red;">Reject</a>
                                                </td>
                                                <?php
                                            }
                                            ?>
