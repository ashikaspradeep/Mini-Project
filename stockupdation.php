...
<body>
    ...
    <form action="stockupdation_action.php" method="post">
        <?php
        include 'db_connection.php';
        $id=$_GET['id'];
        $sql=mysqli_query($connection,"select * from medicine_det where id='$id'");
        while($a=mysqli_fetch_array($sql))
        {

        ?>
        <input type="hidden" name="id" value="<?php echo $a['id'];?>">
    <input type="text" name="name" value="<?php echo $a['medicine_name'];?>" readonly>
    <?php
        }
        ?>
      <input type="text" name="stock" placeholder="Enter No of Stock" required>
