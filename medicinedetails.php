                ...
                <div class="row">
                    <div class="col-lg-6 col-md-6">
                        <div class="contact__form">
                            ...
                            <form action="medicinedetails_action.php" method="post" onSubmit="return check();" enctype="multipart/form-data">
                                <input type="text" name="name" placeholder="Enter Medicine Name">
                                <input type="number" name="quantity" placeholder="Enter quantity Here">
                                <input type="text" name="price" id="cno" placeholder="Enter price" maxlength="6" minlength="1">
                                <input type="date"name="mdate" placeholder="Enter date">
                                  <input type="date" name="expirydate" placeholder="Enter date" min="<?php echo date('Y-m-d');?>">
<textarea name="description" placeholder="Enter Medicine Description"></textarea>
<input type="file" name="file" placeholder="Enter username" required>
        ...
        while($rw=mysqli_fetch_array($sql))
        {
            ...
            <tr>
                ...
                <td><?php echo "<img src='uploads/".$rw['image']."'width='290px' height='170px'";?></td>
                                <td><a href="mdel.php?id=<?php echo $rw['id'];?>">Delete</a></td>
            </tr>
            <?php
                    }
                    ?>
