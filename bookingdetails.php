...
<body>
                    ...
                    <div class="header__menu__option">
                        <nav class="header__menu">
                            <ul>
                                ...
                                <li><a href="searchmedicine.php">Search</a></li>
                                <li><a href="viewbookingstatus.php">Booking Status</a></li>
    ...
    <section class="contact spad">
                ...
                <div class="row">
                    <div class="col-lg-6 col-md-6">
                        <div class="contact__form">
                            ...
                            <form action="bookingdetails_action.php" method="post">
                                <?php
        include 'db_connection.php';
        $sql=mysqli_query($connection,"select * from user_reg where id='$val'");
        while($a=mysqli_fetch_array($sql))
        {
            ?>
                                <input type="hidden" name="id" value="<?php echo $a['id'];?>">
                                <input type="text" name="name" value="<?php echo $a['name'];?>" readonly>
                                <input type="text" name="contact" value="<?php echo $a['contact_no'];?>" readonly>
        ...
        ?>
                                <?php
        $id=$_GET['id'];
        $sq=mysqli_query($connection,"select * from medicine_det where id='$id'");
        $b=mysqli_fetch_array($sq);
        ?>

                                <input type="hidden" name="mid" value="<?php echo $b['id'];?>">
                                <input type="text" name="medname" value="<?php echo $b['medicine_name'];?>" readonly>
                                <input type="text" name="amount" value="<?php echo $b['price'];?>" readonly>

                                <input type="text" name="quantity" placeholder="Enter Quantity" required>
                                <textarea name="address" placeholder="Enter Address"></textarea>
                                <button type="submit" name="submit" class="site-btn">ADD</button>
                            </form>
                        </div>
                    </div>
                    <div class="col-lg-6 col-md-6">
                        ...
                        <div class="footer__copyright__text">
                            <p>Copyright &copy; <script>
                                document.write(new Date().getFullYear());
                                    ...
                                    aria-hidden="true"></i> by <a href="" target="_blank">Musaliar College</a></p>
                        </div>
                        <!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
                    </div>
                    <div class="col-lg-5">
