...
<body>
   ...
   $n=$_POST['name'];
   $sql=mysqli_query($connection,"select * from medicine_det where medicine_name='$n'");
   while($a=mysqli_fetch_array($sql))
   {
    ?>
    <?php echo "<img src='uploads/".$a['image']."'width='290px' height='170px'";?><br><br><br>
    <tr><td>Medicine Name : <?php echo $a['medicine_name'];?></td></tr><br>
    <tr><td>Price : <?php echo $a['price'];?></td></tr><br>
    <tr><td>Quantity : <?php echo $a['quantity'];?></td></tr><br>
    <button type="submit" class="site-btn"><a href="bookingdetails.php?id=<?php echo $a['id'];?>">Book Now</a></button>
    <?php
   }
   ?> </div>
                    </div>
