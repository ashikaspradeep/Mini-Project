...
<body>
    ...
    <!-- Hero Section Begin -->
    <section class="hero spad set-bg" data-setbg="img/7.jpg">
        <div class="container">
            <div class="row">
                <div class="col-lg-6">
                    <div class="hero__text">
                        
                        <h2>Take the world's best quality Medicines</h2>
                            ...
                            <div class="col-lg-6 col-md-6">
                                <div class="consultation__text__item">
                                    <div class="section-title">
                                        <span>Welcom to Med-Shop</span>
                                        <h2>Find Best medicines With <b>Med-Shop</b></h2>
                                    </div>
                                    <p>We have provide chaep rate medicines here. Med-shop is to take the whole medical store online so that it is reachable to customers 24/7.
                                    </p>
                                </div>
                            </div>
                            <div class="col-lg-6 col-md-6">
                                <div class="consultation__video set-bg" data-setbg="img/4.jpg">
