                        ...
                        <div class="col-lg-6 col-md-6">
                            <div class="contact__form">
                                ...
                                <table border="2">
                                    ...
                                    $sq=mysqli_query($connection,"select * from booking_det where uid='$val'");
                                    while($a=mysqli_fetch_array($sq))
                                    {
                                        ...
                                        <tr>
                                            ...
                                            <td><?php echo $a['tamt'];?></td>
                                            <td><?php echo $a['cust_name'];?></td>
                                            <td><?php echo $a['status'];?></td>
                                            <?php
                                            if($a['status']=="Approved" && $a['pstatus']=="pending")
                                            {
                                                ?>
                                                <td>
                                                    <a href="payment.php?id=<?php echo $a['id'];?>" style="color:red;">Make Payment</a>
                                                </td>
                                                <?php
                                            }
                                            ?>
