...
<body>
    ...
    <section class="contact spad">
                ...
                <div class="row">
                    <div class="col-lg-6 col-md-6">
                        <div class="contact__form">
                            <h3>Staff Details</h3>
                            <form action="staffdetails_action.php" method="post" onSubmit="return check();">
                                <input type="text" name="name" placeholder="Enter Name Here" id="name" required>
                                <input type="text" name="gender" placeholder="Enter Gender" id="" required>
                                <input type="text" name="regnumber" placeholder="Enter Reg.No Here" required>
                                <input type="text" name="contact" maxlength="10" minlength="10" id="contact" placeholder="Enter Contact No" required>
        ...
        $sql=mysqli_query($connection,"select * from staff_det");
